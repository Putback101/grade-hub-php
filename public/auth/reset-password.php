...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($token === '') {
        ...
        $user = new User();
        $result = $user->resetPasswordByToken($token, $password);

        if ($result['success']) {
            ActivityLog::log($result['user_id'], 'PASSWORD_RESET', 'User reset password');
            ...
            <form method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="field px-3 py-3">
                        ...
                        <input type="password" name="password" required class="w-full focus:ring-0 focus:outline-none text-sm" style="padding-left: 28px;" placeholder="At least 8 characters">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="field px-3 py-3">
                        ...
                        <input type="password" name="confirm_password" required class="w-full focus:ring-0 focus:outline-none text-sm" style="padding-left: 28px;" placeholder="Repeat new password">
                    </div>
                </div>

                <button type="submit" class="submit-btn w-full text-white font-semibold py-3 rounded-xl transition duration-200" style="margin-top: 12px;">Update Password</button>
            </form>
            <?php endif; ?>
